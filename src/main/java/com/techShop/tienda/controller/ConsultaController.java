...
public class ConsultaController {
    ...
    @PostMapping("/consultaDerivadaFecha")
    public String consultaDerivadaFecha(@RequestParam() @DateTimeFormat(pattern = "yyyy-MM-dd") Date fechaDesde, Model model) {
        var lista = productoService.consultaDerivadaFecha(fechaDesde);
        model.addAttribute("productos", lista);
